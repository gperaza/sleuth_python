...
def driver(
    ...
    if write_iter:
        records[0].init_iter_file(out_path)
...
def optimal_sleuth(records, calibration_stats, urban_years, out_path):
...
def phase1n3(
    ...
    coords = coords[
        prng.integers(100, size=len(coords)) < coef_breed
    ]
